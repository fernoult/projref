...
import org.views.comp.panes.elements.BTElement;
...
//		Border CLine = BorderFactory.createMatteBorder(1, 0, 0, 0, Color.decode("#210B61"));
		...
		TitledBorder title = BorderFactory.createTitledBorder(CLine, Ressources.getInstance().getLibelleValue("prefs.pane.lang.cadre.value"), 
